...
<body>
	<div class="site-wrap">
				...
				<div class="row">
					<div class="col-md-12 mb-0">
						<a href="/">Trang chủ</a> <span class="mx-2 mb-0">/</span> <strong
							class="text-black">Hồ sơ cá nhân</strong>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="site-section">
			<div class="container">
				<form class="row" action="profile-page" method="post"
					enctype="multipart/form-data">
					<div class="col-md-4">
						<div class="row">
							<div class="col-md-12">
								<h2 class="h3 mb-3 text-black">Ảnh đại diện</h2>
								...
								<div class="p-3 border d-flex justify-content-center">
									<label class="m-0" for="imgInp">
										...
										<figcaption style="text-align: center">Nhấn vào
											đây để thay đổi ảnh đại diện</figcaption>
					...
					<div class="col-md-8 mb-5 mb-md-0">
						...
						<div class="p-3 p-lg-5 border">
							...
							<div class="form-group">
								<label for="summary" class="text-black"> Tóm tắt </label>
							...
							<div class="form-group">
								<button type="submit"
									class="btn btn-primary btn-lg py-3 btn-block">Cập nhật
									hồ sơ</button>
							</div>
						</div>
					</div>

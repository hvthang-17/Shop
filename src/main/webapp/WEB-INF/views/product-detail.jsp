						...
						<form action="cart?product-id=&quantity=" method="get">
							<div class="mb-3">
								<div class="input-group mb-3" style="max-width: 200px;">
									...
									<label for="quantity" class="form-label text-black"> Số
										sản phẩm: ${product.amount} </label>
								</div>
							</div>

							<p>
								<button type="submit" class="buy-now btn btn-sm btn-primary"
									${disabled}>Thêm vào giỏ hàng</button>
							</p>
						</form>
					</div>
				</div>
				...
				<c:if test="${alert}">
					<div class="row justify-content-center mt-3">
						<div class="alert alert-danger d-flex justify-content-center"
							...
							<strong class="font-weight-bold"> Chỉ còn
								${product.amount} sản phẩm trong kho! </strong>
						</div>
					</div>
				</c:if>
			</div>

			...
			<div class="container">
				<div class="row">
					<div class="col-md-12 mb-0">
						<a href="/Antiques/">Trang chủ</a> <span class="mx-2 mb-0">/</span>
						...
						<div class="row">
							<div class="col-md-12 mb-5">
								<div class="float-md-left mb-4">
									<h2 class="text-black h5">Xem tất cả sản phẩm</h2>
								</div>
								<div class="d-flex">
									<div class="dropdown mr-1 ml-md-auto">
										<div class="btn-group">
											...
											<div class="dropdown-menu"
												...
												<a class="dropdown-item" href="#">Phù hợp nhất</a> <a
													class="dropdown-item" href="#">Tên, A đến Z</a> <a
													class="dropdown-item" href="#">Tên, Z đến A</a>
												<div class="dropdown-divider"></div>
												<a class="dropdown-item" href="#">Giá, thấp đến cao</a> <a
													class="dropdown-item" href="#">Giá, cao đến thấp</a>
											</div>
										</div>
									</div>
								</div>
							...
							<ul class="list-unstyled mb-0">
								<c:forEach items="${category_list}" var="o">
									<li class="mb-1 active"><a
										href="category?category_id=${o.id}" class="d-flex"> <span>${o.name}</span>
